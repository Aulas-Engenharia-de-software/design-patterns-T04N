...
export function NotificationWarning({ message, closeNotification }: NotificationWarningProps) {
  return (
    <div className="fixed bg-black/80 w-full h-full flex items-center justify-center">
      <div className="relative bg-yellow-50 w-full max-w-2xl h-full max-h-80 rounded-lg p-8 flex flex-col items-center justify-center border-2 border-yellow-600">
        <div className="absolute top-0 left-0 flex items-center justify-between w-full p-4">
          <div className="flex items-center gap-1">
            <p className="font-medium text-yellow-600 text-lg">Aviso</p>
