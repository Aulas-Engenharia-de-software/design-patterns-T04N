...
export function NotificationSuccess({ message, closeNotification }: NotificationSuccessProps) {
  return (
    <div className={`fixed bg-black/80 w-full h-full flex items-center justify-center`}>
      <div className="relative bg-green-50 w-full max-w-2xl h-full max-h-80 rounded-lg p-8 flex flex-col items-center justify-center border-2 border-green-600">
        <div className="absolute top-0 left-0 flex items-center justify-between w-full p-4">
          <div className="flex items-center gap-1">
            <p className="font-medium text-green-600 text-lg">Sucesso</p>
